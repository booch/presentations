...
* I would not recommend relying on that in `if` statements.
...
* I'd like to take a short detour here to talk about something called "connascence".
...
> _production of multiple things at the same time_

> _the act of growing together_

???

* *Connascence* was a word before computers were around.
* Here are some definitions from Webster's dictionary, from 1913.
...
![What Every Programmer Should Know About Object-Oriented Design](images/Page-Jones-1996.jpg)

???

* In 1992, Meilir (may-LEER) Page-Jones brought the idea to the OOP community.
...
* I also shared some links to other articles and sites talking about connascence.

------

* Full PDF of Meilir Page-Jones's original paper:
...
* Here's (roughly) Meilir's definition of connascence.
* (read through the slide)
...
* In 2009, Jim Weirich brought the idea of connascence to the Ruby community.
...
* Here's (roughly) Jim's definition.
* (read through the slide)
...
* Jim makes the argument that connascence underlies many other rules of good OO design.
    * DRY
    * Code smells
    * Race conditions
* So we want to **reduce** connascence, like we want to reduce coupling.

------

* [Grand Unified Theory of Software Design](https://vimeo.com/10837903)
    * Slides: https://github.com/jimweirich/presentation_connascence
    * Another version of the talk, with better audio, but worse video:
...
* Here's a list of the types of _static_ connascence.
    * They're ordered from weakest connascence to strongest.
        * So we should prefer the ones near the top.
* There are _dynamic_ types of connascence too.
    * The dynamic types of connascence are all _stronger_ then these.
...
* Connascence of Type
    ...
    * In Ruby, this means duck typing
* Connascence of Meaning
...
* Remember, we always want to try to **reduce** connascence.
...
* We replaced a Boolean parameter with a specific meaning with a named parameter.
* That specific meaning is more difficult to remember.
* We reduced connascence by replacing Connascence of Meaning with Connascence of Name.
...
* Booleans are often not the best choice
* Readability matters
...
_The best thing about a Boolean is even if you're wrong, you're only off by a bit._

???

* A co-worker told me this joke.
* The only joke I could find about Booleans.
