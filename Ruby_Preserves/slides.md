...
* But I don't think the Active Record pattern is usually the right choice
* I'm still looking for the ideal ORM implementing the Data Mapper pattern
* In a way, I'm exploring things so maybe I can write the ideal Data Mapper ORM
    * This is the "one to throw away"
